...
For this guide, let's create a Hazelcast Viridian Cluster. First, sign in to the link:https://cloud.hazelcast.com/[{hazelcast-cloud} console,window=_blank], and follow the xref:get-started.adoc[Get Started with the Hazelcast CLC] tutorial.
