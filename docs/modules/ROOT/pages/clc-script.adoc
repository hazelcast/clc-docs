= clc script
:description: Runs the script in the given local or HTTP location. Advanced script currently only supports local files.
...
[source,bash]
----
clc script [path/location] [flags] -- [parameter, ...]
----
